...
{
	[MenuItem("Project/Create/ScriptableObject/Asset")]
	...
	public static void Create()
	{
		...
		var allScriptableObjects = (from t in assembly.GetTypes()
		                            ...
		                            select t).ToArray();
		//DebugLogger.Log(null, "type:" + type);
		//DebugLogger.Log(null, "type:" + type.Assembly.FullName);
		//DebugLogger.Log(null, "type:" + type.IsSubclassOf(typeof(ScriptableObject)));
