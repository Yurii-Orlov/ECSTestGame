    ...
    public class DOTweenAnimation : ABSAnimationComponent
    {
        ...
        public void CreateTween()
        {
            ...
            case DOTweenAnimationType.Color:
                ...
                else if (t.IsSameOrSubclassOf(typeof(Light))) tween = ((Light)target).DOColor(endValueColor, duration);
#if DOTWEEN_TK2D
            ...
            case DOTweenAnimationType.Fade:
                ...
                else if (t.IsSameOrSubclassOf(typeof(Light))) tween = ((Light)target).DOIntensity(endValueFloat, duration);
